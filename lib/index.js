            ...
            */
            ...
            if(m2mode === "js") {
                if(fs__WEBPACK_IMPORTED_MODULE_1___default.a.existsSync(`${output}/index.js`)) {
                    ...
                    const compiler = webpack__WEBPACK_IMPORTED_MODULE_2___default()(Object(_webpack_m2builder_config__WEBPACK_IMPORTED_MODULE_5__["default"])({input, mode}));
                    compiler.run((err) => {
                        if(err) throw err;
                        fs__WEBPACK_IMPORTED_MODULE_1___default.a.readFile(`${output}/index.js`, "utf8", (err, data) => {
                            if (err) throw err;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (({input, mode}) => ({
    devtool: "(none)",
        mode,
        entry: {
    'index': [input]
