...
class Builder {
    ...
    constructor({
        ...
        const compiler = webpack__WEBPACK_IMPORTED_MODULE_1___default()({
            ...
            output: {
                path: path__WEBPACK_IMPORTED_MODULE_2___default.a.resolve(dirname, './dist/'),
                filename: `${name}.js`,
            },
            module: {
                rules: [
        ...
        this.server = new webpack_dev_server__WEBPACK_IMPORTED_MODULE_0___default.a(compiler, {
            ...
            hot: true,
            inline: true,
            after: Object(_resolver__WEBPACK_IMPORTED_MODULE_3__["default"])( { dirname, m2units: { units, dir: m2unitsDir}, mode } ),
...
function after({ dirname, mode, m2units: { units, dir = "/m2units" } }) {
    ...
    return function (app) {
        ...
        app.get(`${dir}/*`, function(req, res) {
            ...
            const input = path__WEBPACK_IMPORTED_MODULE_0___default.a.resolve(dirname, `./../../../node_modules/${name}/src/index.js`);
